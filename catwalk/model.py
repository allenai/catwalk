...
class TrainableModel(Model):
    ...
    def collate(self, instances: Sequence[Tuple[Task, Instance]]) -> Any:
        """
    ...
    def trainable_model(self) -> torch.nn.Module:
        """
        Returns a trainable version of the model. Catwalk expects that this model's ``forward()`` method takes
        the input that's generated by :meth:`collate()`, and returns a dictionary that contains the loss under
        the key ``"loss"``.
        """
        raise NotImplementedError
